export const projectsData = [
  {
    ...
    brief: [
      "TimberSmart에서 텀 프로젝트를 하면서 개발하던 프로젝트입니다.",
      "자바와 안드로이드 스튜디오를 활용하여 안드로이드 기기에서 사용가능한 바코드 스캐너를 개발하였습니다.",
      "단순히 바코드를 스캔하는것 뿐만 아니라 각각의 바코드를 스캔,저장,검색,공유기능 등을 통한 효율적인 자재관리를 위한 앱입니다.",
      "4명으로 이루어진 팀에 참여하여 스캐너 & 저장의 기능 구현을 담당하여 총 프로젝트의 30% 이상의 기여도를 보였습니다.",
    ],
  },
  {
    id: "modal2",
